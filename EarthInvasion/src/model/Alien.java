...
public class Alien extends GameObject {
    ...
    /**
     * Returns the value of reloadCounter.
    ...
    */
    ...
    /**
     * Return if the player is allowed to fire.
     * @return if the player is allowed to fire.
     */
    ...
    /**
     * Sets if the player is allowed to fire.
     * @param canFire, sets if the player is allowed to fire.
     */
